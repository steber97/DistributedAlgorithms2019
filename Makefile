...
da_proc: da_proc.cpp  link.o utilities.o ur_broadcast.o be_broadcast.o lcob_broadcast.o
	g++ $(CFLAG) -o da_proc da_proc.cpp utilities.o link.o ur_broadcast.o be_broadcast.o lcob_broadcast.o
...
clean:
	rm da_proc lcob_broadcast.o ur_broadcast.o be_broadcast.o link.o utilities.o
